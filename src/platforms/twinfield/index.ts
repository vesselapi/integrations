...
export default platform('twinfield', {
  auth: auth.oauth2({
   authUrl: "https://login.twinfield.com/auth/authentication/connect/authorize",
   tokenUrl: "https://login.twinfield.com/auth/authentication/connect/token",
   requiredScopes: ["openid","twf.user","twf.organisation","twf.organisationUser","offline_access"],
   authParams: {
