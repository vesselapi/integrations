...
export const outreachProspect = custom.addNativeToZodSchema(
  z.object({
    id: z.number(),
    attributes: z.object({
...
export const outreachAccount = custom.addNativeToZodSchema(
  z.object({
    id: z.number(),
    attributes: z.object({
...
export const outreachEmailAddress = custom.addNativeToZodSchema(
  z.object({
    id: z.number(),
    attributes: z.object({}),
    relationships: z.object({}),
...
export const outreachUser = custom.addNativeToZodSchema(
  z.object({
    id: z.number(),
    attributes: z.object({
      firstName: z.string(),
...
export const outreachMailbox = custom.addNativeToZodSchema(
  z.object({
    id: z.number(),
    attributes: z.object({
      email: z.string(),
...
export const outreachSequence = custom.addNativeToZodSchema(
  z.object({
    id: z.number(),
    attributes: z.object({
      name: z.string(),
...
export const outreachSequenceState = custom.addNativeToZodSchema(
  z.object({
    id: z.number(),
    attributes: z.object({}),
    relationships: z.object({
...
export const outreachMailing = custom.addNativeToZodSchema(
  z.object({
    id: z.number(),
    attributes: z.object({
...
export const outreachSequenceStep = custom.addNativeToZodSchema(
  z.object({
    id: z.number(),
    attributes: z.object({
...
export const outreachTemplate = custom.addNativeToZodSchema(
  z.object({
    id: z.number(),
    attributes: z.object({
...
export const outreachSequenceTemplate = custom.addNativeToZodSchema(
  z.object({
    id: z.number(),
    attributes: z.object({
      bounceCount: z.number().nullable(),
