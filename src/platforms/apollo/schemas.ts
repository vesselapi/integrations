...
export const apolloSequenceTemplate = z.object({
  id: z.string(),
  emailer_step_id: z.string().nullable(),
  emailer_template_id: z.string().nullable(),
  status: z.string().nullable(),
  type: z.string().nullable(),
  include_signature: z.boolean().nullable(),
  has_personalized_opener: z.boolean().nullable(),
  personalized_opener_fallback_option: z.string().nullable(),
  generic_personalized_opener: z.string().nullable(),
  unique_scheduled: z.number().nullable(),
  unique_delivered: z.number().nullable(),
  unique_bounced: z.number().nullable(),
  unique_opened: z.number().nullable(),
  unique_replied: z.number().nullable(),
  bounce_rate: z.number().nullable(),
  open_rate: z.number().nullable(),
  reply_rate: z.number().nullable(),
  demo_rate: z.number().nullable(),
  unique_demoed: z.number().nullable(),
  unique_clicked: z.number().nullable(),
  click_rate: z.number().nullable(),
  unique_unsubscribed: z.number().nullable(),
  opt_out_rate: z.number().nullable(),
  unique_hard_bounced: z.number().nullable(),
  unique_spam_blocked: z.number().nullable(),
  hard_bounce_rate: z.number().nullable(),
  spam_block_rate: z.number().nullable(),
});
