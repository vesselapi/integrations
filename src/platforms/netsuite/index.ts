...
export default platform('netsuite', {
  auth: auth.oauth2({
    authUrl: ({ answers }) =>
      `https://${answers.accountId}.app.netsuite.com/app/login/oauth2/authorize.nl`,
    tokenUrl: ({ answers }) =>
      `https://${answers.accountId}.suitetalk.api.netsuite.com/services/rest/auth/oauth2/v1/token`,
    requiredScopes: ['restlets'],
    questions: [
      {
        id: 'accountId',
        label: 'What is your Netsuite AccountId?',
        type: 'text',
      },
    ],
  }),
